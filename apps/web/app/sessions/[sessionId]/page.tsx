          ...
          <div className="flex flex-wrap items-center gap-2">
            {analysisResult && (
              <Link
                ...
                className="text-sm px-3 py-1.5 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 whitespace-nowrap"
              >
                Print report
              </Link>
            )}
            <button onClick={handleDeleteSession} disabled={deleting}
              className="text-sm px-3 py-1.5 border border-red-200 text-red-600 rounded-lg hover:bg-red-50 disabled:opacity-50 whitespace-nowrap">
